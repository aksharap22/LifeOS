...
This bundled extension manages the **coding agent context/instruction file** (e.g. `GEMINI.md`, `CLAUDE.md`, `.github/copilot-instructions.md`, `AGENTS.md`, …) for the active integration.
