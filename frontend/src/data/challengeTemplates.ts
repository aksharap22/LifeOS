...
export const challengeTemplates: ChallengeTemplate[] = [
  ...
  },
  {
    ...
    category: 'Growth',
    duration: 10,
    description: 'Dedicate 15 minutes daily to a skill you enjoy or a creative task where you finish a product. Aim for completion.',
  ...
  },
  {
    ...
    category: 'Growth',
    duration: 30,
    description: 'Learn 5 words/phrases daily. Use at least one in a sentence. Please specify the Language you are learning in the Title when you create this.',
